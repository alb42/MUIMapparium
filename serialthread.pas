...
begin
  ...
  begin
    ...
    Data.Course := StrToFloatDef(SL[8], 0);
    Data.Lat := la;
    Data.Lon := lo;
    Data.Valid := True;
    DebugOut('Position: ' + FloatToStrF(Data.Lat, ffFixed, 8, 6) + ';' + FloatToStrF(Data.Lon, ffFixed, 8, 6) + ' - ' + FloatToStr(Data.Course) +' (' + SL[8] + ') ' + DateTimeToStr(ti));
  end;
end;
...
begin
  ...
  begin
    ...
    DebugOut('Pos: ' + FloatToStrF(Data.Lat, ffFixed, 8, 6) + ';' + FloatToStrF(Data.Lon, ffFixed, 8, 6) + ' ' + TimeToStr(ti));
  end;
end;
...
begin
  ...
  begin
    ...
    Data.Lat := la;
    Data.Lon := lo;
    DebugOut('Position: ' + FloatToStrF(Data.Lat, ffFixed, 8, 6) + ';' + FloatToStrF(Data.Lon, ffFixed, 8, 6) + ' ' + DateTimeToStr(ti));
    //
