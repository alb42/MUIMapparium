...
const
  ...
  MSG_TRACKPROP_DATE = 20413 ;
  MSG_TRACKPROP_DATE_STR = 'Date'#0;

  MSG_TRACKPROP_MOVETIME = 20414 ;
  MSG_TRACKPROP_MOVETIME_STR = 'Time moving'#0;

  MSG_TRACKPROP_AVGSPEED = 20415 ;
  MSG_TRACKPROP_AVGSPEED_STR = 'Average Speed'#0;

  MSG_TRACKPROP_MOVESPEED = 20416 ;
  MSG_TRACKPROP_MOVESPEED_STR = 'Move Speed'#0;

  MSG_TRACKPROP_MAXSPEED = 20417 ;
  MSG_TRACKPROP_MAXSPEED_STR = 'Max Speed'#0;

  MSG_TRACKPROP_HEIGHTDIFF = 20418 ;
  MSG_TRACKPROP_HEIGHTDIFF_STR = 'Height Difference'#0;
  ...
  MSG_ROUTEPOP_EXPORT = 20612 ;
  MSG_ROUTEPOP_EXPORT_STR = 'Export'#0;

  MSG_ROUTEPOP_EXPORTHTML = 20613 ;
  MSG_ROUTEPOP_EXPORTHTML_STR = 'Export as HTML'#0;
  ...
  MSG_MENU_MAIN_EXPORTPNG = 30107 ;
  MSG_MENU_MAIN_EXPORTPNG_STR = 'Export as PNG...'#0;
...
const
  AppStrings: TAppStringArray = (
    ...
    (id: MSG_TRACKPROP_DATE ; str: MSG_TRACKPROP_DATE_STR ),
    (id: MSG_TRACKPROP_MOVETIME ; str: MSG_TRACKPROP_MOVETIME_STR ),
    (id: MSG_TRACKPROP_AVGSPEED ; str: MSG_TRACKPROP_AVGSPEED_STR ),
    (id: MSG_TRACKPROP_MOVESPEED ; str: MSG_TRACKPROP_MOVESPEED_STR ),
    (id: MSG_TRACKPROP_MAXSPEED ; str: MSG_TRACKPROP_MAXSPEED_STR ),
    (id: MSG_TRACKPROP_HEIGHTDIFF ; str: MSG_TRACKPROP_HEIGHTDIFF_STR ),
    ...
    (id: MSG_ROUTEPOP_EXPORT ; str: MSG_ROUTEPOP_EXPORT_STR ),
    (id: MSG_ROUTEPOP_EXPORTHTML ; str: MSG_ROUTEPOP_EXPORTHTML_STR ),
    ...
    (id: MSG_MENU_MAIN_EXPORTPNG ; str: MSG_MENU_MAIN_EXPORTPNG_STR ),
