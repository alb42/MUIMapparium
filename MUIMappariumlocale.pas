...
const
  ...
  MSG_FRAME_ROUTES = 2005 ;
  MSG_FRAME_ROUTES_STR = 'Routes'#0;

  MSG_FRAME_IMAGES = 2006 ;
  ...
  MSG_MENU_MAP_DRAWMARKER = 3204 ;
  MSG_MENU_MAP_DRAWMARKER_STR = 'Draw Marker'#0;

  MSG_MENU_MAP_DRAWTRACKS = 3205 ;
  MSG_MENU_MAP_DRAWTRACKS_STR = 'Draw Tracks'#0;

  MSG_MENU_MAP_DRAWROUTES = 3206 ;
...
type
  ...
  TAppStringArray = array[0..95] of TAppString;
